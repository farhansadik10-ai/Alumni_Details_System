...
export class AlumniQuery{
    ...
    public async crateAlumni (alumni:AlumniDTO):Promise<AlumniDTO>{
        const info = await pool.query('INSER INTO users (user_id,department,graduation_yr?,current_company?,job_title?,experience?,bio,linkedin_url)VALUES($1,$2,$3,$4,$5,$6,$7,$8) RETURNING*',
            [alumni.user_id,
             alumni.department,
